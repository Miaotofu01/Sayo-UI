...
interface SayoCursorOptions {
  ...
  size?: number;
  /** Pressed diameter (default: 26) */
  pressSize?: number;
  /** Glow radius normal (default: 40) */
  glowNormal?: number;
  /** Glow radius when hovering interactive elements (default: 50) */
  glowHover?: number;
  /** Glow radius on press (default: 70) */
  glowPress?: number;
  /** Glow opacity normal (default: 0.08) */
  glowIntensity?: number;
  /** Glow opacity when hovering interactive elements (default: 0.14) */
  glowIntensityHover?: number;
  /** Glow opacity on press (default: 0.18) */
